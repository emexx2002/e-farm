...
interface ITmpPaginator {
 ...
 export const Paginator = ({
    ...
    const classes = {
      ...
      item: " h-9 min-w-[2.25rem] bg-black-light px-3 py-1 cursor-pointer text-black",
      itemActive: "!text-white !bg-[#000000] px-4",
        ...
        <button
          ...
          className={clsx([
            ...
            leftArrowDisabled
              ...
              : "cursor-pointer text-black border rounded border-primary",
          ])}
        >
          Previous
        </button>
