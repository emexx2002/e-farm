    ...
    <div>
      <div className='w-full flex justify-between items-center bg-gray-200 py-4 px-6 text-xl'>
        <div className='flex items-center gap-3 '>
          ...
          <h3 className='text-[#000000] font-bold'>Dashboard</h3>
        </div>
      </div>
      <div className='md:px-6 py-6 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-2 px-2 items-center gap-3 justify-center'>
        <InfoCard header='Total Sales' value='500,000.00' iconBg='#000000' iconName='naira' percentage='12%' />
        <InfoCard header='Product Sales' value='500,000.00' iconBg='#000000' iconName='store' percentage='12%' />
        <InfoCard header='Service Sales' value='500,000.00' iconBg='#000000' iconName='business' percentage='12%' />
        <InfoCard header='Total Profit' value='500,000.00' iconBg='#000000' iconName='naira' percentage='12%' />
        <InfoCard header='Profitall Wallet' value='500,000.00' iconBg='#000000' iconName='naira' percentage='12%' />
        ...
        <InfoCard header='Monthly Profit' value='500,000.00' iconBg='#000000' iconName='naira' percentage='12%' />
          ...
          <GraphWrapper graphTitle="Overall Sale">
            <div className='flex items-center gap-3'>
              <div className='flex items-center gap-2'>
                <div className='h-4 w-4 rounded-full bg-[#000000]' />Products
              </div>
              <div className='flex items-center gap-2'>
